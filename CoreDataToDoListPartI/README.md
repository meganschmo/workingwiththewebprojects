...
- Then make a new function called `refreshData` that will refetch the items from the `ItemManager`, set the result to this new `incompleteItems` property, and reload the table
